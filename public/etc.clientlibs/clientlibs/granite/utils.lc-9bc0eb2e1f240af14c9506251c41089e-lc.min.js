...
a));return b},removeAnchor:function(b){var a=b.indexOf("#");return 0<=a?b.substring(0,a):b},removeParameters:function(b){var a=b.indexOf("?");return 0<=a?b.substring(0,a):b},encodePathOfURI:function(b){for(var a=["?","#"],g=[b],d,e=0,f=a.length;e<f;e++)if(d=a[e],0<=b.indexOf(d)){g=b.split(d);break}h.test(g[0])&&(g[0]=c.encodePath(g[0]));return g.join(d)},encodePath:function(a){a=encodeURI(a);a=a.replace(/%5B/g,"[").replace(/%5D/g,"]");a=a.replace(/\?/g,"%3F");return a=a.replace(/#/g,"%23")},handleLoginRedirect:function(){if(!k){k=
!0;alert(Granite.I18n.get("Your request could not be completed because you have been signed out."));var b=a.getTopWindow().document.location;b.href=c.externalize("/")+"?resource\x3d"+encodeURIComponent(b.pathname+b.search+b.hash)}},getXhrHook:function(a,c,g){return window.G_XHR_HOOK&&"function"===typeof G_XHR_HOOK?(a={url:a,method:c||"GET"},g&&(a.params=g),G_XHR_HOOK(a)):null},eval:function(a){"object"!==typeof a&&(a=e.ajax({url:a,type:"get",async:!1}));try{return JSON.parse(a.body?a.body:a.responseText)}catch(m){}return null}};
return c}()});
...
"");if(0<=a.getCookieNames().indexOf(f))return!0}return!1};a.maySetCookie=function(d){return!(a.isOptedOut()&&-1===a.getWhitelistCookieNames().indexOf(d))};return a}()});(function(a){"object"===typeof module&&module.exports?module.exports=a():(window.Granite=window.Granite||{}).Toggles=a()})(function(){return{RT_NOVEMBER:"ft-cq-4309511",RT_DECEMBER:"ft-cq-4310036",RT_JANUARY:"ft-cq-4296639",isEnabled:function(a){return 0<=window.Granite.HTTP.eval("/etc.clientlibs/toggles.json").enabled.indexOf(a)}}});
